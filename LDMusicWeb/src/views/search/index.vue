        ...
        <div >
            <div class="search-main">
                ...
                <div class="search-list">
                    ...
                    <user-list :userList="list" :offset="offset" :currentpage="currentpage" :limit="limit" v-if="type === '1002'"></user-list>
                </div>
    ...
    methods: {
        ...
        async getSerachMatch () {
            ...
            if (this.type === '1') {
                ...
                this.list = res.result.userprofiles
                this.totle = res.result.userprofileCount
                console.log(`res.result.userprofileCount`, res.result.userprofileCount)
            }
        },
        jumpSearch (k) {
            if (!k) {
