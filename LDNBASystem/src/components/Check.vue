...
import { reactive, ref, onMounted, toRaw,defineProps} from 'vue'
const {label,prop,status,handleChange} = defineProps({
    label:{
        type: String,
        required: true,
        default: () => "未命名"
...
<template>
  <div class="toggle-border">
    ...
    <input :id="prop" type="checkbox" :checked="status" @change="(e)=>{handleChange(e,prop)}"/>
    <label :for="prop">
