...
class Modal extends React.PureComponent<any,any>{
    /* 渲染底部按钮 */
    renderFooter=()=>{
    ...
    static show: (config: any) => { setShow: null; mounted: boolean; hidden(): void; destory(): void } | undefined
    static hidden: () => void
    render(){
...
Modal.show = function(config){
   ...
   const ModelApp = (props: { [x: string]: any; visible: any }) => {
